 ...
 * Dra. Angélica não está verificado lá, então o padrão sai de `sintetiza.ai`
...
const REMETENTE_PADRAO = "Site Dra. Angélica Manfroi <nao-responda@sintetiza.ai>";
const DESTINO_PADRAO = "contato@angelicamanfroi.com.br";
