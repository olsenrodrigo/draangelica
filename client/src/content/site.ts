...
export const site = {
  ...
  hero: {
    ...
    subtitle: "Dra. Angélica Manfroi, médica de família e comunidade, com doutorado em Educação Médica e formação em Medicina de Estilo de Vida.",
  ...
  about: {
    ...
    paragraphs: [
      "Formada em Medicina pela UFRGS, com residência em Medicina de Família e Comunidade no Grupo Hospital Conceição, em Porto Alegre, um dos centros formadores de referência no Brasil. Tenho doutorado em Educação Médica, sou professora universitária em Atenção Primária e também tenho formação em Medicina de Estilo de Vida.",
  ...
  conditionsIntro: { eyebrow: "Como posso ajudar", title: "Cuidado para diferentes momentos da sua saúde" },
  conditions: [
    { icon: "heart", title: "Hipertensão e diabetes: acompanhamento contínuo", lead: "Acompanhamento contínuo de doenças crônicas.", text: "Hipertensão e diabetes exigem acompanhamento constante, ajuste de tratamento e mudança de hábito, não apenas a renovação de receita. A consulta de medicina de família olha para o conjunto: alimentação, rotina, exames de controle e os outros fatores que influenciam a doença.", whenTitle: "Quando procurar", when: "Diagnóstico recente, dificuldade em controlar os níveis, dúvidas sobre medicação ou vontade de reduzir o uso de remédios com mudança de estilo de vida." },
  ...
  children: { title: "Saúde infantil básica", text: "Também acolho demandas simples de saúde infantil (como resfriados e queixas do dia a dia), encaminhando a um pediatra sempre que o caso pedir um acompanhamento mais especializado." },
  differentials: { title: "Diferenciais", items: ["Coordenação do cuidado entre diferentes frentes de tratamento", "Doutorado em Educação Médica e formação em Medicina de Estilo de Vida", "Consulta de 50 minutos, com tempo real para ouvir o paciente", "Atendimento particular em São Paulo, em dois endereços"] },
  locations: {
  ...
  form: {
    ...
    reasonPlaceholder: "Selecione uma opção", reasons: ["Hipertensão/Diabetes", "Climatério e menopausa", "Sono, ansiedade ou dor crônica", "Check-up e prevenção", "Outro"],
